...
- (id)init
{
    self = [super init];
    if (self) {
        CCSprite * sprite1 = [CCSprite spriteWithFile:@"background.png"];
        sprite1.anchorPoint = ccp(0, 0);
        sprite1.position = ccp(0, 0);
        [self addChild:sprite1];
        CCSprite * sprite2 = [CCSprite spriteWithFile:@"background.png"];
        sprite2.anchorPoint = ccp(0, 0);
        sprite2.position = ccp(0, 480);
        [self addChild:sprite2];
        CCSprite * sprite3 = [CCSprite spriteWithFile:@"background.png"];
